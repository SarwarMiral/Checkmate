...
public class First_Step_One extends AppCompatActivity {
    ImageView next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_activity_first_one_one);
        ...
        takeNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent first_step_two = new Intent(First_Step_One.this, RemindMe.class);
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                First_Step_One.this.finish();
                startActivity(home);
            }
        });
        RelativeLayout textHolderRL = (RelativeLayout) findViewById(R.id.text_holder);
        textHolderRL.startAnimation(AnimationUtils.loadAnimation(First_Step_One.this, R.anim.slide_in_bottom));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent first_step_two = new Intent(First_Step_One.this, First_Step_Two.class);
                startActivity(first_step_two);
            }
        });
    ...
    private void setBanglaTexts() {
        if (pref.getString("language", "bangla").equals("bangla")) {
            ...
            description.setText("†Kvg‡i nv‡Zi Zvjy " +
                    "†i‡L\nwb‡Pi w`‡K m‡Rv‡i Pvc w`b\n" +
                    "hv‡Z ey‡Ki gvsm†ckx‡Z Uvb a‡i,\n" +
                    "jÿ¨ Kiæb ¯Í‡bi AvK…wZ‡Z †Kvb\n" +
                    "cwieZ©b, ùxwZ wKsev Z¡‡K\n" +
                    "†Kv_vI †Uvj c‡o‡Q wKbv\n");
            int resID = getResources().getIdentifier("bangla1", "raw", getPackageName());
            mediaPlayer = MediaPlayer.create(this, resID);
            mediaPlayer.start();

        } else {
            int resID = getResources().getIdentifier("step1", "raw", getPackageName());
            mediaPlayer = MediaPlayer.create(this, resID);
            mediaPlayer.start();
        }
    }
