 ...
 */
public class Second_Step_Two extends AppCompatActivity {
    ImageView next,prev;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_two_two);
        ...
        takeNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent first_step_two = new Intent(Second_Step_Two.this, RemindMe.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent first_step_two = new Intent(Second_Step_Two.this, Second_Step_Three.class);
                startActivity(first_step_two);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Second_Step_Two.super.onBackPressed();
            }
        });
    ...
    private void setBanglaTexts() {
        if (pref.getString("language", "bangla").equals("bangla")) {
            ...
            rightMark.setText("2.2");
            takeNote.setTypeface(typeface);
            takeNote.setText("†bvU ivLyb");
            description.setText("eMj cix¶v Kiyb\n" +
                    "†Kvb PvKv Av‡Q wKbv\n" +
                    "†`Lvi Rb¨\n");
            int resID = getResources().getIdentifier("bangla4", "raw", getPackageName());
            mediaPlayer = MediaPlayer.create(this, resID);
            mediaPlayer.start();

        } else {
            int resID = getResources().getIdentifier("step4", "raw", getPackageName());
            mediaPlayer = MediaPlayer.create(this, resID);
            mediaPlayer.start();
        }
    }
